...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3" style="font-size: 15px;"><sup>PT </sup>Purna Usaha Mandiri</div>
    ...
    <li class="nav-item <?=isset($transaksi)?'active':'';?>">
        ...
        <div id="transaksi" class="collapse <?=isset($transaksi)?'show':'';?>" aria-labelledby="headingTwo"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?=isset($instalasi)?'active':'';?>" href="?instalasi">Instalasi Listrik</a>
            </div>
        </div>
    </li>
    <?php endif; ?>
